...
# --- Helper Functions ---
# Fungsi ini bertugas menyiapkan dataframe khusus untuk setiap chart
# supaya kode utama lebih rapi.
...
# Memfilter data berdasarkan inputan user
main_df = all_df[(all_df["order_purchase_timestamp"] >= str(start_date)) & 
                (all_df["order_purchase_timestamp"] <= str(end_date))]

# Menyiapkan berbagai dataframe hasil olahan
